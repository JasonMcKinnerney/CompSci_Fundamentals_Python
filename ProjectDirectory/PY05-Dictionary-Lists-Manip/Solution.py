...
def display_planets(sol):
    print("{:>12} {:>12} {:>15} {:>15} {:>15}".format("planet", "status", "nearest", "furthest", "average"))
    print("{:-^73s}".format("-"))
    for planet in sol:
        print("{:>12} {:>12} {:>15} {:>15} {:>15}".format(planet, sol[planet][3], sol[planet][0], sol[planet][1],sol[planet][2]))
